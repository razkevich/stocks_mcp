...
public class StockChartsApplication {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0 && "--mcp".equals(args[0])) {
            ...
            // Start Spring Boot REST API server
            SpringApplication.run(StockChartsApplication.class, args);
        }
    }
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                try {
                    ...
                    McpMessage response = handleMcpRequest(request, chartTool, dataTool);
    ...
    private static McpMessage handleMcpRequest(McpMessage request, StockChartTool chartTool, StockDataTool dataTool) throws Exception {
